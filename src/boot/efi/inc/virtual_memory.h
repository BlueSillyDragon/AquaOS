...
void mapPages(pagemap_t pagemap, uint64_t virtAddress, uint64_t physAddress, uint64_t flags, uint64_t count);

uint64_t virtToPhys(pagemap_t pagemap, uint64_t virt_address);